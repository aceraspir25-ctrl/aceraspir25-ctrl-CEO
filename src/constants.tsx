...
export const PERSONA_RECOMMENDED_SCREENS: Record<UserPersona, ScreenStatus[]> = {
  CEO: ['COMMAND_SYSTEM', 'EXECUTIVE', 'DASHBOARD', 'MARKET', 'HR', 'PRODUCT', 'SECURITY'],
  ENGINEER: ['COMMAND_SYSTEM', 'ENGINEERING', 'INFRA', 'QA', 'SECURITY', 'DASHBOARD', 'WORKLOAD'],
  HR: ['HR', 'DASHBOARD', 'EXECUTIVE', 'WORKLOAD'],
  PRODUCT: ['COMMAND_SYSTEM', 'PRODUCT', 'MARKET', 'DASHBOARD', 'DESIGN', 'ENGINEERING'],
  SALES: ['SALES', 'MARKET', 'DASHBOARD', 'PRODUCT'],
  DESIGN: ['DESIGN', 'PRODUCT', 'DASHBOARD', 'MARKET'],
  BOD: ['EXECUTIVE', 'MARKET', 'DASHBOARD', 'SECURITY'],
  QA: ['QA', 'ENGINEERING', 'DASHBOARD', 'WORKLOAD'],
  DEVOPS: ['COMMAND_SYSTEM', 'INFRA', 'ENGINEERING', 'SECURITY', 'WORKLOAD'],
  GUIDE: ['GUIDE', 'DASHBOARD', 'MARKET'],
  STAFF: ['DASHBOARD', 'HR', 'WORKLOAD', 'GUIDE'],
};
